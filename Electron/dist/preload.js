...
window.onload = function () {
    ...
    $("#download").on("click", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            totalSize = 0;
            totalDownloaded = 0;
            async.each(files, function (file, callback) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    getSize(file.url).then(function (size) {
                        file.size = size;
                        processed += 1;
                ...
                async.each(files, function (file, callback) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        getMBits = function () {
                            ...
                            var mbits = roundDecimalPlace(difference / 1000 / 1000, 2);
                        ...
                        emitter.on("progress", function (args) {
                            ...
                            if (percent != undefined) {
                                ...
                                var total = roundDecimalPlace(totalDownloaded / totalSize * 100, 2);
                                //@ts-ignore
...
function roundDecimalPlace(Number, place) {
